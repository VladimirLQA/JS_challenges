...

{
    function whatNumberIsIt(n){
        switch(n){
            case Number.MAX_VALUE: return console.log("Input number is Number.MAX_VALUE");
            case Number.MIN_VALUE: return  console.log("Input number is Number.MIN_VALUE");
            case Number.POSITIVE_INFINITY: return console.log("Input number is Number.POSITIVE_INFINITY");
            case Number.NEGATIVE_INFINITY: return console.log("Input number is Number.NEGATIVE_INFINITY");
            case Number(n) : return console.log("Input number is " + n);
            default: return console.log("Input number is Number.NaN");
        }
    }
...

{
    const whatNumberIsIt = n =>
        console.log(`Input number is ${Number.isNaN(n) ? `Number.NaN` :
