/**
 * It looks at the letter, and sees it is indexed in the alphabet,
 * the alphabet being a-z, if you didn't know. If it is odd,
 * it is replaced with 1, if it's even, it's replaced with 0.
...
const encode = (plaintext) =>
  plaintext.replace(/[a-z]/gi, (c) => 1 - (c.charCodeAt(0) % 2));
